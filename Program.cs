        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                catch
                {
                    ...
                    Console.WriteLine("Tidak sDsssapat sssssssssssmengaksses saDatxxsasaabase Menggunakan User Tersebut\n");
                    Console.WriteLine("Tidak sDapasaa3t ddmengakssssssessa Drata Tersebut\n");
                    Console.ResetColor();
                }
            }
        }
